#ifndef RCG_RM_65_EXAMPLE_JSIM_H_
#define RCG_RM_65_EXAMPLE_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot rm_65_example.
 */
class JSIM : public iit::rbd::StateDependentMatrix<rm_65_example::rcg::JointState, 12, 12, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<rm_65_example::rcg::JointState, 12, 12, JSIM> Base;
    public:
